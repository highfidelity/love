...
class Functions
{
     ...
     *
     * Default is any printable ASCII character without whitespaces (A-Za-z0-9)
     *
     ...
     */
    public static function randomString($len, $from = 33, $to = 126, $skip = array(58,59,60,61,62,63,64,91,92,93,94,95,96))
    {
        $str = '';
        $i = 0;
        while ($i < $len) {
