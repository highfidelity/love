...
<?php include("views/head.php"); ?>
	<div id="privacyInfo">   
		...
		<ul style="display: block;list-style-type: disc;margin: 1em 20px;">
			<li style="margin-bottom: 7px;display: list-item;">To personalize your experience <br />
			(your information helps us to better respond to your individual needs)</li>
			<li style="margin-bottom: 7px;display: list-item;">To improve our website <br />
			(we continually strive to improve our website offerings based on the information and feedback we receive from you)</li>
			<li style="margin-bottom: 7px;display: list-item;">To improve customer service<br />
		...
		<h2>Contacting Us</h2>
		<p>If there are any questions regarding this privacy policy, please contact us at <a href="mailto:contact@below92.com">contact@below92.com</a></p>
	</div>
<!-- Footer -->
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-11529958-4']);
