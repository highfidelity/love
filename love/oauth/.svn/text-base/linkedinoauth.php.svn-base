 ...
 *
 * Tweaked by Pedro Dias (petermdias@gmail.com) to support OAuth v1.0a
 *
 */
...
class LinkedInOAuth {
    ...
    */
    function getRequestToken($callbackurl) {/*{{{*/
        ...
        $this->request_options = array_merge(array('oauth_callback' => $callbackurl), $this->request_options);
