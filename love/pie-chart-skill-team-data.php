...
$category = EnumArg('category', array('sent', 'received'));

if (!$subject || !$from_date || !$to_date || !$category) {
    exit;
}
...
if($category =='sent') {
  ...
  $categoryType = "receiver";
}

$love = getData($company_id, $subject, $categoryType, $from_date, $to_date);
