...
<div id="contentBody">
  <div id="contentBodyLeft">
	<div class="hTitle hTitle2">Privacy Statement</div><br/>
	<div style="clear:both;"></div>        
		<span>	
			...
			<p><a href="http://www.sendlove.us" title="Sendlove Home Page" target="_blank">www.sendlove.us</a></p>
			<p>San Francisco, CA  94127, USA</p>
			<p>admin (at) below92 (dot) com</p>
		</span>               
	<div style="clear:both;"></div>
  </div>
  <div id="contentBodyRight"></div>
  <div style="clear:both;"></div>
</div>
