...
LoveChart = {
    ...
    load:function (data,fAfter) {
        ...
        var leftPoints = LoveChart.chart.getSeriesMax(data.points,5);
        ...
        messages = LoveChart.chart.normalizeSeriesFloat(data.points, leftPoints);
        ...
        LoveChart.chart.popupTextCallback = function (xs) {
	        ...
	        return [
	            { fill:'#F4B645', font:'bold 11px Arial, sans-serif', text:' Total : $'+ formatAsCurrency( parseInt(amount*selectedMessageValue * leftMax)/100+'') + 
                    ' (' + data.points[o] + ') ' },
